...
<div class="widget-content">
    <div class="admin-info">
        ...
        <div>{$lang.txt.membersince}: {$user_info.signup|date_format:"%b %e, %Y"}</div>
...
<div id="tabs">
	<ul>
    	<li><a href="#tab-1">{$lang.txt.general_stats}</a></li>
    	<li><a href="#tab-2">{$lang.txt.advertiser_stats}</a></li>
    	<li><a href="#tab-3">{$lang.txt.charts}</a></li>
    	<li><a href="#tab-4">{$lang.txt.login_failures}</a></li>
    </ul>
    <div id="tab-1">
        ...
        <table width="100%" class="tbl-content" cellpadding="4">
            <tr>
                ...
                <td><strong>{set_amount($user_info.money)}</strong></td>
            ...
            <tr>
                ...
                <td><strong>{set_amount($user_info.purchase_balance)}</strong></td>
	...
	<div id="tab-3">
        <!-- Content -->
        {html_script('assets/fusioncharts/FusionCharts.js')}
    ...
    <div id="tab-4">
        <div class="widget-title">{$lang.txt.login_failures}</div>
        <div class="widget-content">
        {if !empty($loginfailure)}
            {section name=f loop=$loginfailure}
                <div class="error_login">
                    ...
                    <div><strong>{$lang.txt.date}:</strong> {$loginfailure[f].date|date_format:"%b %e %Y %r"}</div>
                </div>
            {/section}
        {else}
