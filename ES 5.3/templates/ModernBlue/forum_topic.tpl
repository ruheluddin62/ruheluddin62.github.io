...
<div style="float:left">
    ...
    {else}
        {$frm_topic.date|date_format:"%Y-%m-%d at %H:%M"}
    {/if}
</div>
...
<div class="frm-content">
    ...
    <div id="postid{$item.id}" style="padding:10px;">
        ...
        {else}
            {if $item.member.forum_role != 1}
                <img src="{base_url('assets/evolution/images/flags/'|cat:$item.member.flag|cat:'.png')}" title="{$item.member.country}" />
            {/if}
            {$item.author}
        {/if}
        		</td>
                ...
                {else}
                    {$item.date|date_format:"%Y-%m-%d at %H:%M"}
                {/if}
                </div>
                </td>
			</tr>
    ...
    <table align="center">
                ...
                {/if}
                    <tr>
                        <td align="center" style="border:1px solid #d5d5d5; background:#f4f4f4">
                            ...
                            {else}
                            {base_url('assets/evolution/images/forum/user_no_avatar.jpg')}
                            {/if}
                    ...
                    <tr>
                        <td align="center">
                        <a href="./?view=account&page=messages&to={$item.member.id}#tab-2"><img src="{base_url('assets/evolution/images/forum/mail.gif')}" border="0" /></a>
                        </td>
                    </tr>
                        {/if}
                    {/if}
                    ...
                    <tr>
                        <td>
                        <img src="images/memberbar/forumf.png" />
                            {$lang.txt.received}: {set_amount($item.member.withdraw)}
                        </td>
                    </tr>
                    <tr>
                        <td>
                        <img src="images/memberbar/forumf.png" />
                            {$lang.txt.balance}: {set_amount($item.member.money)}
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            {if $item.member.forum_role != 4}
                ...
                {else}
                    <strong>{$item.edit_date|date_format:"%Y-%m-%d at %H:%M"}</strong>
                {/if}
