...
<tr class="titles">
        ...
        {foreach item=item from=$thelist}
            <tr>
                ...
                <td align="center">{$item.rented_time|date_format:"%d-%m-%Y"}</td>
                <td align="center">{$item.days_left} days</td>
                <td align="center">{if $item.rented_lastclick != 0}{$item.rented_lastclick|date_format:"%d-%m-%Y"}{else}{$lang.txt.never}{/if}</td>
