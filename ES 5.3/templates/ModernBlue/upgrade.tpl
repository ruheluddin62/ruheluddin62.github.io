...
<table width="100%" cellpadding="4" class="widget-tbl">
    ...
    <tr>
        ...
        {section name=m loop=$themembership}
         <td><strong>{$themembership[m].click}%</strong> {$lang.txt.of_click_value}</td>
        {/section} 
    </tr>
    <tr>
    	<td>{$lang.txt.perrefclick}</td>
        {section name=m loop=$themembership}
         <td><strong>{$themembership[m].ref_click}%</strong> {$lang.txt.of_click_value}</td>
        {/section} 
    </tr>
    <tr>
    ...
    <tr>
        ...
        {section name=m loop=$themembership}
        <td>
          {set_amount($themembership[m].ref_upgrade)}
   		</td>
        {/section} 
    </tr>
    <tr>
    ...
    <tr>
        ...
        {section name=m loop=$themembership}
        <td>
          {set_amount($themembership[m].recycle_cost)}
   		</td>
        {/section} 
    </tr>
    ...
    <tr>
        ...
        {section name=m loop=$themembership}
        <td>
          {$themembership[m].rent_time} day(s)
   		</td>
        {/section} 
    </tr>
    <tr>
        ...
        {section name=m loop=$themembership}
        <td>
          {$themembership[m].cashout_time} day(s)
   		</td>
        {/section} 
    </tr>
    ...
    <tr>
        ...
        {section name=m loop=$themembership}
        <td>
          {if $themembership[m].referral_deletion == 0}Free{else}{$themembership[m].referral_deletion}{/if}
   		</td>
        {/section} 
    </tr>
    <tr>
        ...
        {section name=m loop=$themembership}
        <td>
          {if $themembership[m].instant_withdrawal == 'yes'}{$lang.txt.yes}{else}{$lang.txt.no}{/if}
   		</td>
        {/section} 
    </tr>
    <tr>
        ...
        {section name=m loop=$themembership}
         <td><strong>{set_amount($themembership[m].price)}</strong></td>
        {/section} 
    </tr>
</table>
...
function hide_gateways(){
	...
	$("#addfrm").fadeIn();
            ...
            <div id="gateway-{$gateways[n].id}" style="display:none" class="gatewayfrm">
                ...
                <div align="center">
                <img src="{base_url('assets/evolution/images/gateway_deposit/'|cat:{$gateways[n].id}|cat:'.png')}" width="100" class="pointer" onclick="document.forms['checkout{$gateways[n].id}'].submit();" />
