...
<tr class="titles">
        ...
        {foreach item=item from=$thelist}
            <tr>
                ...
                <td align="center">{$item.signup|date_format:"%b %e, %Y"}</td>
                <td align="center">{if $item.for_reflastclick == 0}{$lang.txt.never}{else}{$item.for_reflastclick|date_format:"%b %e, %Y"}{/if}</td>
