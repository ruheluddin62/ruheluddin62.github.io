...
<table width="100%" class="widget-tbl">
	<tr>
        ...
        <td><input name="title" type="text" id="title" maxlength="{$settings.ptc_chars_title}" onkeyup="textCounter(this,'counter',{$settings.ptc_chars_title});" /> <span id="counter">0</span>/{$settings.ptc_chars_title} chars</td>
    </tr>
    <tr>
    	<td align="right">{$lang.txt.subtitle}</td>
        <td><input name="subtitle" type="text" id="subtitle" maxlength="{$settings.ptc_chars_descr}" onkeyup="textCounter(this,'counter2',{$settings.ptc_chars_descr});" /> <span id="counter2">0</span>/{$settings.ptc_chars_descr} chars</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input name="imgurl" type="text" id="imgurl" value="http://" maxlength="200" onkeyup="textCounter(this,'counter4',200);" /> <span id="counter4">0</span>/200 chars</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
           ...
           {foreach item=advalue from=$listvalue}
           		<option value="{$advalue.id}">{set_amount($advalue.value)} {$lang.txt.perclick} - {$advalue.time} {$lang.txt.seconds}</option>
           {/foreach}
          </select>
        </td>
    </tr>
    <tr>
    	<td align="right">{$lang.txt.targetcountry}</td>
        <td>
...
<table width="100%" class="widget-tbl">
	...
	<tr>
        ...
        <td>
           <select name="advalue" id="advalue">
           {foreach item=advalue from=$listvalue}
           		<option value="{$advalue.id}">{set_amount($advalue.value)}</option>
           {/foreach}
          </select>
        </td>
    </tr>
